  ...
  return (
    <div className="w-full inter px-2">
      <div className="relative mb-12">
        {/* Background Track */}
        <div className="h-0.5 bg-amber-100 w-full absolute top-1/2 -translate-y-1/2 left-0" />
        
        {/* Active Progress Fill */}
        <div
          className="h-0.5 bg-linear-to-r from-amber-300 via-[#FFC107] to-amber-300 absolute top-1/2 -translate-y-1/2 left-0 transition-all duration-1000 ease-in-out shadow-[0_0_15px_rgba(255,193,7,0.2)]"
              ...
              <div key={i} className="flex flex-col items-center group">
                ...
                <div className="relative flex items-center justify-center">
                  ...
                  <div className={`absolute w-10 h-10 rounded-full transition-all duration-500 scale-150 ${
                    isActive ? "bg-amber-200 blur-md" : "bg-transparent"
                  }`} />
                  ...
                  <div
                    className={`w-4 h-4 rounded-full flex items-center justify-center transition-all duration-500 z-10 border shadow-2xl ${
                      isCompleted
                        ...
                        : isActive
                        ? "bg-white border-[#FFC107] scale-125 ring-4 ring-[#FFC107]/20"
                ...
                {/* Label Section */}
                <div className="absolute -bottom-8 flex min-w-25 flex-col items-center">
                  <span className={`text-[10px] tracking-[0.3em] uppercase font-bold transition-all duration-300 ${
                    isActive ? "text-[#FFC107] translate-y-1" : isCompleted ? "text-slate-600" : "text-slate-400"
                  }`}>
                    {label}
                  </span>
